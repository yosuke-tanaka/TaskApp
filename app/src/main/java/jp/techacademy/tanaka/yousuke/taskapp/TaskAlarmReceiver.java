...
/**
 * Created by yt_home on 2016/08/27.
 */
...
// アラームを受け取ったときに通知を出したいのでTaskAlarmReceiverに処理を実装します。
// NotificationはNotificationCompat.Builderクラスを使って作成します。

//setContentIntentメソッドで指定するIntentはアラームのときと同じようにIntentを作成し、
// そのIntentを指定して作成したPendingIntentです。
